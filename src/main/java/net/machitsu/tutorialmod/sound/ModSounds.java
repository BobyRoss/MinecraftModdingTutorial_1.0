package net.machitsu.tutorialmod.sound;
...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> CHARLES = registerSoundEvent("charles");
    public static final ResourceKey<JukeboxSong> CHARLES_KEY = ResourceKey.create(Registries.JUKEBOX_SONG,
            ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "charles"));
