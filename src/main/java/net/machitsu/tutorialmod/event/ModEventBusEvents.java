...
import net.machitsu.tutorialmod.entity.client.TomahawkProjectileModel;
import net.machitsu.tutorialmod.entity.client.TriceratopsModel;
...
public class ModEventBusEvents {
    ...
    public static void registerSpawnPlacements(SpawnPlacementRegisterEvent event){
        event.register(ModEntities.TRICERATOPS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                Animal::checkAnimalSpawnRules, SpawnPlacementRegisterEvent.Operation.REPLACE);//:: are calles predicates
    }
